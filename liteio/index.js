...
function index_timer_proc(obj)
{
  ...
  //liteio_WebSocket.socket.write("Hello");
...
function index_periodic_proc(obj)
{
  ...
  conole.log('index_periodic_proc');


  //codeXWebSocket.socket.write("Hello");
  //console.log("write -> Hello ");

  clearTimeout(periodic_proc)
  periodic_proc = setTimeout(index_periodic_proc, 1000, obj);
}
...
function index_init()
{
  ...
  periodic_proc = setTimeout(index_periodic_proc, 1000, 0);
...
///////////////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////////////////
var GraphUpper = new liteio_chart();
var GraphLower = new liteio_chart();
